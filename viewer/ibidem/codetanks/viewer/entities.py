...
class Tank(Entity):
    ...
    dead_image_name = pkg_resources.resource_filename("ibidem.codetanks.viewer.resources", "tombstone.png")
    _layer = 10
    ...
    def __init__(self, e):
        ...
        self.dead_image = pygame.image.load(self.dead_image_name).convert_alpha()

    def update_visuals(self):
        if self.status == BotStatus.DEAD:
